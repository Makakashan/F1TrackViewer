...
/** Circuits currently on the F1 race calendar. */
...
/** Average lat/lon of every circuit in a continent bucket. */
...
/** The year embedded in the id is the layout's opening year, e.g. "gb-1948" → 1948. */
