...
const en = {
  ...
  raceBetaBody:
    "The circuit, the grid and the start lights are in place; the race itself is not simulated yet. Expect rough edges — placement is derived from circuit geometry, so a few layouts still look off.",
  raceBetaAck: "Got it",
  raceLap: "Lap",
  raceLaps: "Laps",
  raceStandby: "Ready to start",
  raceLightsOut: "Lights out",
  raceStartDemo: "Lights demo",
  raceStartDemoHint: "Runs the start sequence. The cars do not move yet.",
  raceGridOrder: "Grid",
  raceShuffle: "Shuffle",
...
const ru: Dict = {
  ...
  raceBetaBody:
    "Трасса, решётка и стартовые огни уже на месте, но сама гонка ещё не симулируется. Возможны шероховатости: расстановка выводится из геометрии трассы, поэтому кое-где она пока выглядит криво.",
  raceBetaAck: "Понятно",
  raceLap: "Круг",
  raceLaps: "Кругов",
  raceStandby: "Готов к старту",
  raceLightsOut: "Старт",
  raceStartDemo: "Демо старта",
  raceStartDemoHint: "Прогоняет стартовую последовательность. Машины пока не едут.",
