...
export const BAKED_MESH_COLORS: Record<"light" | "dark", Record<BakedMeshKind, string>> = {
  light: {
    ...
    // A roof is not a wall painted from above: it is gravel, zinc or tile. The
    // material is near-white and the bake's own paint says which — a dark
    // material could only make a terracotta pitch muddy.
    roof: "#E2E5E9",
